"""
Este script nos permite graficar el contenido de selection.txt, un archivo que contiene los pasos que le toma al Quick sort
...
steps = np.loadtxt('quick_steps.txt')

plt.plot(range(0,101),steps, label="Número de pasos")
plt.title("La gráfica del rendimiento de Quick Sort.", fontsize = 20)
plt.legend()
