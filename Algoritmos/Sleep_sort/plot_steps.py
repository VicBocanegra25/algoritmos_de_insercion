"""
Este script nos permite graficar el contenido de bubble_steps.txt, un archivo que contiene los pasos que le toma al sleep sort
...
steps = np.loadtxt('sleep_steps.txt')

plt.plot(range(0,101),steps, label="Número de pasos")
plt.title("La gráfica del rendimiento de Sleep Sort.")
plt.legend()
plt.ylabel("Pasos")
